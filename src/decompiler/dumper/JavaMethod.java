...
public class JavaMethod {
    ...
    private RMethod myRMethod;

    /*
     * Java code modified (valid char naming, no dup method signatures)
     */
    ...
    public JavaMethod(RMethod rMethod, JavaClass parentJavaClass) {
        ...
        if (rMethod.getName().equals("<init>")) {
            methodName = parentJavaClass.getClassName();
            this.returnType = null;
        }
        else if (rMethod.getName().equals("<clinit>")){
            methodName = null;
            returnType = null;
        } else {
            ...
            this.returnType = NameUtil.toValidName(
                    JavaUtil.getReturnType(rMethod.getDescriptor(), null));
        }
        ...
        for (int index=0; index<code.size(); index++) {
            ...
            switch (opcode) {
                ...
                case LDC:           // push constant
                    STACK.push("" + RItem.getEntry(code.get(++index)).getValue());
                    continue;
                case BIPUSH:
                ...
                case PUTFIELD:
                    ...
                    generatedCode.add("this." +
                            NameUtil.toValidName(RItem.getEntry(field_index).getName()) +
                            " = " + STACK.pop() + ";");
                    continue;
                /*
                    TODO:
                ...
                case NEW: {
                    ...
                    String newName = NameUtil.toValidTypeName(
                            JavaUtil.getUnqualifiedName((String) RItem.getEntry(constIndex).getValue()));
